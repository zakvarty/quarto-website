...
::: medium_right
<img style = "border-radius: 10%;" src="http-request.png" alt="Schematic diagram showing the structure of an HTTP request, composed of: a URL, method, headers and body.">
:::
...
::: medium_left
<img style = "border-radius: 10%;" src="http-response.png" alt="Schematic diagram showing the structure of an HTTP response, composed of: a status code, headers and body.">
:::
