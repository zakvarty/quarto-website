...
5.  Testing minises error.
6.  Work *can* be reproducible.
7.  Research ought to be credible communication.

There is a large crossover between these and (REF good enough practices in scientific communication)

-   "In another study, 29 research teams recently collaborated on a project focusing on applied statistics to see if the same answers would emarge from re-analyses of the same dataset [@silberzahn2015]. They don't."
...
> "We all learn by doing. When we create a reproducible workflow and share reporducible materials we improve both cumulation of knowledge and our methos for doing social science."
>
